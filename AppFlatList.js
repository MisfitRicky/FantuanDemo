...
const Item = ({ title }) => (
    <View style={styles.item}>
      <FantuanImage
        ...
        // url={"https://i.picsum.photos/id/1084/200/200.jpg?hmac=xQYOwJzrnLV26FtETQNbcf3y4H2IUqFTWagLcKPfrbA"}
        showTitle={'sdfsafsdfsdfdsfdsf'}
